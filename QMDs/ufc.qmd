...
talk about variables that are going to be hard to quantify (pound for pound ranks maybe take out, what is constant_1, empty_arena, location, country, date, R_ev, B_ev, column000) take out empty arena for sure
...
```{python}
ufc_cleaned_data = ufc_cleaned_data.drop(columns = "R_ev", "B_ev", "date", "column000", "empty_arena", "constant_1", "country", "location")
```
